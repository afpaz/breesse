...
/**
 * This is the item provider adapter for a {@link ca.ets.sofeess.breesse.simulink.Condition} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 SimulinkPackage.Literals.CONDITION__DESCRIPTION,
				 true,
				 false,
				 false,
	...
	protected void addStatementPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Condition_statement_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Condition_statement_feature", "_UI_Condition_type"),
				 SimulinkPackage.Literals.CONDITION__STATEMENT,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
