...
/**
 * This is the item provider adapter for a {@link ca.ets.sofeess.breesse.simulink.Function} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class FunctionItemProvider extends CompositeStateflowElementItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Function_signature_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Function_signature_feature", "_UI_Function_type"),
				 SimulinkPackage.Literals.FUNCTION__SIGNATURE,
				 true,
				 false,
				 false,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Function.class)) {
			case SimulinkPackage.FUNCTION__SIGNATURE:
