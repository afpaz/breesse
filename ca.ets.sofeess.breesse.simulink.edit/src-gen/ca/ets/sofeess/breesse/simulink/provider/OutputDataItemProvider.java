...
/**
 * This is the item provider adapter for a {@link ca.ets.sofeess.breesse.simulink.OutputData} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class OutputDataItemProvider extends DataItemProvider {
	/**
	...
	protected void addConnectionPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_OutPort_connection_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_OutPort_connection_feature", "_UI_OutPort_type"),
	...
	public String getText(Object object) {
		String label = ((OutputData)object).getName();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(OutputData.class)) {
