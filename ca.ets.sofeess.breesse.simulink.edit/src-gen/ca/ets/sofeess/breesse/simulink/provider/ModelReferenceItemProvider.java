...
/**
 * This is the item provider adapter for a {@link ca.ets.sofeess.breesse.simulink.ModelReference} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ModelReferenceItemProvider extends ReferenceItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ModelReference_modelName_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ModelReference_modelName_feature", "_UI_ModelReference_type"),
				 SimulinkPackage.Literals.MODEL_REFERENCE__MODEL_NAME,
				 true,
				 false,
				 false,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(ModelReference.class)) {
			case SimulinkPackage.MODEL_REFERENCE__MODEL_NAME:
