...
/**
 * This is the item provider adapter for a {@link ca.ets.sofeess.breesse.simulink.Reference} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ReferenceItemProvider extends SubSystemItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Reference_sourceBlock_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Reference_sourceBlock_feature", "_UI_Reference_type"),
				 SimulinkPackage.Literals.REFERENCE__SOURCE_BLOCK,
				 true,
				 false,
				 true,
				 null,
