...
/**
 * This is the item provider adapter for a {@link ca.ets.sofeess.breesse.simulink.Vertex} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class VertexItemProvider extends ContainableStateflowElementItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 SimulinkPackage.Literals.VERTEX__INCOMING_TRANSITIONS,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 SimulinkPackage.Literals.VERTEX__OUTGOING_TRANSITIONS,
				 true,
				 false,
				 true,
				 null,
