...
/**
 * This is the item provider adapter for a {@link ca.ets.sofeess.breesse.simulink.SubSystem} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SubSystemItemProvider extends BlockItemProvider {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(SimulinkPackage.Literals.SUB_SYSTEM__CONNECTIONS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(SimulinkPackage.Literals.SUB_SYSTEM__SUB_BLOCKS,
				 SimulinkFactory.eINSTANCE.createSimulinkModel()));
		...
		newChildDescriptors.add
			(createChildParameter
				(SimulinkPackage.Literals.SUB_SYSTEM__SUB_BLOCKS,
				 SimulinkFactory.eINSTANCE.createChart()));

		newChildDescriptors.add
			(createChildParameter
				(SimulinkPackage.Literals.SUB_SYSTEM__SUB_BLOCKS,
				 SimulinkFactory.eINSTANCE.createTruthTableChart()));

		newChildDescriptors.add
			(createChildParameter
				(SimulinkPackage.Literals.SUB_SYSTEM__SUB_BLOCKS,
				 SimulinkFactory.eINSTANCE.createBlockReference()));
		...
		newChildDescriptors.add
			(createChildParameter
				(SimulinkPackage.Literals.SUB_SYSTEM__CONNECTIONS,
				 SimulinkFactory.eINSTANCE.createConnection()));
	}
