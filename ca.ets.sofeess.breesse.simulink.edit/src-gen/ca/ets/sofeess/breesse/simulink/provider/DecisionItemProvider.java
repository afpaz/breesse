...
/**
 * This is the item provider adapter for a {@link ca.ets.sofeess.breesse.simulink.Decision} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DecisionItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Decision_actionReference_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Decision_actionReference_feature", "_UI_Decision_type"),
				 SimulinkPackage.Literals.DECISION__ACTION_REFERENCE,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 SimulinkPackage.Literals.DECISION__ID,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(SimulinkPackage.Literals.DECISION__DECISION_ENTRIES);
		}
	...
	public String getText(Object object) {
		...
		return getString("_UI_Decision_type") + " " + decision.getId();
	}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(SimulinkPackage.Literals.DECISION__DECISION_ENTRIES,
				 SimulinkFactory.eINSTANCE.createDecisionEntry()));
	}
